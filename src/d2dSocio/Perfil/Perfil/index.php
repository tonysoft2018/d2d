                                                        ...
                                                        <div id="face-segunda" style="text-align:center;">
                                                            ...
                                                            <div class="row"> 
                                                                <div class="col-sm-12"> 
                                                                    ...
                                                                    <select class="custom-select" id="create-estado-door2door" name="create-estado-door2door"  >
                                                                    </select>
                                                                </div>                                                
                                                            </div><br>
                                                            <div class="row"> 
                                                                <div class="col-sm-12"> 
                                                                    ...
                                                                    <select class="custom-select" id="create-municipio-door2door" name="create-municipio-door2door"  >
                                                                    </select>
                                                                </div>
                                                            </div><br><br><br>
                                                            <div class="row">
                                                    ...
                                                    <form id="form-face-cuarta-door2door" enctype="multipart/form-data"  style="display:none;"> 
                                                        ...
                                                        <center>
                                                            <div id="face-cuarta" style="text-align:center;">
                                                                    ...
                                                                    <div class="row"  id="button-Cargar-imegen-comprobante-door2door">                
                                                                        <div class="col-sm-12" id="update-comprobante-door2door">                  
                                                    ...
                                                    <form id="form-face-quinta-door2door" enctype="multipart/form-data"style="display:none"> 
                                                        ...
                                                        <div id="face-quinta" style="text-align:center;">
                                                            ...
                                                            <div class="row" id="button-Cargar-imegen-INEF-door2door">                
                                                                <div class="col-sm-12" id="update-imagen-INEF-door2door">                  
                                                                    <img src="/door2door/Modules/ModulesImage/imagen.jpg" style="width:200px;height:200px;" class="">
                                                                </div>
                                                            </div><br> 
                                                        </div><br>
                                                    ...
                                                    <form id="form-face-sexta-door2door" enctype="multipart/form-data"style="display:none"> 
                                                        ...
                                                        <div id="face-sexta" style="text-align:center;">
                                                            ...
                                                            <div class="row" id="button-Cargar-imegen-INED-door2door">                 
                                                                <div class="col-sm-12" id="update-imagen-INED-door2door">                  
                                                                    <img src="/door2door/Modules/ModulesImage/imagen.jpg" style="width:200px;height:200px;" class="">
                                                                </div>
                                                            </div><br> 
                                                        </div><br>
