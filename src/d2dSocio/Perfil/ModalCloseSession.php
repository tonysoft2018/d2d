    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-sm-12">
              <center>
                  <img class="img-fluid"  src="<?= $URL?>/d2dSocio/Modules/ModulesImage/pregunta.png" style="width:150px;height:150px;"  >
                  <br> <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <a      href="<?= $URL ?>/d2dSocio/closeSession/controller/closeSession.php" 
