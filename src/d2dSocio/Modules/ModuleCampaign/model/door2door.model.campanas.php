...
namespace  d2dSocio\Modules\ModuleCampaign\Model\Campanas;
    /*<Includes>*/
        include_once('../../ModulePugins/door2door.Cofiguration.Conection.php');
    /*<Includes>*/
    /*<use>*/
        use  d2dSocio\Modules\ModulePugins\Conection\Conection as ConectionCampanas;
    /*<use>*/
                ...
                /*<Query> */
                    $querySelect = 'SELECT 
                                            ...
                                            (
                                                SELECT usu.nombres 
                                                    FROM usuarios usu 
                                                    WHERE usu.idUsuario = cam.idUsuario
                                            )AS NombreSocio,
                                            (
                                                SELECT usu.nombres 
                                                    FROM usuarios usu 
                                            ...
                                            (
                                                SELECT count(con.idContacto)
                                                    FROM contacto con 
                                                    WHERE con.idCampana = cam.idCampana 
                                            )AS numeroContactos
                                        FROM campana cam 
                                        WHERE 
                                                cam.fecha       BETWEEN "'.$FechaInicio.'" AND "'.$FechaFinal.'" AND
