    ...
    {  
        ...
        /*<Main Module Roles>*/               
            /*<Consultar toda la iformacion>*/    
                ...
                $('#main-inicio-door2door').val(FECHA);
                $('#main-final-door2door').val(FECHA);
               

                setTimeout(() => {
                    const functionSFA = functionSelectFullAPI(FECHA,FECHA).
                ...
                $('#main-inicio-door2door').on('change',  () => {
                    let FechaInicio = $('#main-inicio-door2door').val();
                    let FechaFinal  = $('#main-final-door2door').val();
                    console.log(FechaInicio); console.log(FechaFinal);
                ...
                $('#main-final-door2door').on('change',  () => {
                    let FechaInicio = $('#main-inicio-door2door').val();
                    let FechaFinal  = $('#main-final-door2door').val();
                    console.log(FechaInicio); console.log(FechaFinal);
                    const functionSFA = functionSelectFullAPI(FechaInicio,FechaFinal).
