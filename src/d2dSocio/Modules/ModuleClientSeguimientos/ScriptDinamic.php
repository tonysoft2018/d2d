<script>
    ...
    /*<Event Button Show # 1 >*/
        const SelectedMap  = ( 
                ...
                $('#selected-latitud-contacto-door2door').val(latitud);
                $('#selected-logitud-contacto-door2door').val(longitud);

                $('#selected-latitud-visitante-door2door').val(latitudVisitante);
                $('#selected-logitud-visitante-door2door').val(longitudVisitante);
