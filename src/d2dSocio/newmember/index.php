                ...
                <div class="card login-form">
                    <div class="card-body">
                        ...
                        <div class="card-text">                           
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="/d2dSocio/login/"  id="button-inicialr-sesion-door2door" class="btn btn-success btn-block">Inicio de sesion</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="module">               
            ...
            {                 
                ...
                { 
                    ...
                    let informationForm             = new FormData(
                        document.getElementById("form-create-member-door2door")
                    ); 
                    
                    let TockenOfdoor2doordoor2door  =   $('#tocken-door2doors-01198756765345431234534').val();
                        informationForm.append( 
                            "TockenOfdoor2doordoor2door" ,   
                             TockenOfdoor2doordoor2door
                         );   
                                            ...
                                            if(correo.includes('@'))
                                            {
                                                ...
                                                {                        
                                                    ...
                                                    {                   console.log(result)     
                                                        ...
                                                        {
                                                            localStorage.setItem( 'JSON_INFORMACION', 
                                                                JSON.stringify(
                                                                    result.RESPUETA_CREAR_SOLICITUD.information
                                                                )
                                                            );
                ...
                $('#message-regresar-door2door').on('click', () => {  window.location.href = "/d2dSocio/Perfil/Perfil" });  
            });
