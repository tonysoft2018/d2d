...
/*<Import>*/   
    ...
    use  d2dVisitador\Modules\ModulePugins\Conection\Conection             as Conection;
    ...
    <body>  
        ...
        <script type="module">               
            ...
            $( document ).ready( () => { 
                $('#button-cambiar-contrasena-door2door').on('click', () => { 
                    ...
                    if(PASSWORD_UNO != '' && PASSWORD_DOS != '')
                    {
                        if(PASSWORD_UNO == PASSWORD_DOS){
                                ...
                                $.ajax({
                                    url: "/d2dVisitador/newpassword/tocken/api/door2door.controller.newmember.php",
                                    type: 'post',
                ...
                /*<REGRESAR>*/
                    $('#button-regresar-token').on('click', () => { window.location.href = "/d2dSocio/login/"; });
                /*<REGRESAR>*/
            });
