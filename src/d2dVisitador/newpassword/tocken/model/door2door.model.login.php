<?php
namespace  d2dVisitador\Login\Model\Login;
    /*<Includes>*/
        include_once('../../Modules/ModulePugins/door2door.Cofiguration.Conection.php');
    /*<Includes>*/
    
    /*<use>*/
        use  d2dVisitador\Modules\ModulePugins\Conection\Conection as ConectionLogin;
    /*<use>*/
    ...
    class Login extends ConectionLogin{
        ...
        /*<Method Session>*/
            private function session($JSON_RESULT){
                ...
                session_start();
                    $_SESSION["idUser-door2door"]    = $JSON_RESULT["idUsuario"];
                    $_SESSION["user-door2door"]      = $JSON_RESULT["usuario"];
                    $_SESSION["name-door2door"]      = $JSON_RESULT["nombre"];
                    $_SESSION["email-door2door"]     = $JSON_RESULT["email"];
                    $_SESSION["typeUser-door2door"]  = $JSON_RESULT["tipoUsuario"];
                    $_SESSION["imagen-door2door"]    = $JSON_RESULT["imagen"];
