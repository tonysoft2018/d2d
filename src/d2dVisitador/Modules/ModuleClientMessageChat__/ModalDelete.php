    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-delete-door2door">
          <input type="hidden" value="" id="delete-id-door2door" name="delete-id-door2door">
      </form>
        <div class="row">
            <div class="col-sm-4"></div>
            <div class="col-sm-4">              
              <img class="img-fluid"  src="<?= $URL?>/d2dVisitador/Modules/ModulesImage/pregunta.png" style="width:150px;height:150px;"  ><br> 
