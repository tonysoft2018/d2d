...
(function (global, factory) {
  ...
  var PushMenu = /*#__PURE__*/function () {
    ...
    _proto.expand = function expand() {
      ...
      $bodySelector.addClass(CLASS_NAME_IS_OPENING$1).removeClass(CLASS_NAME_COLLAPSED + " " + CLASS_NAME_CLOSED).delay(1500).queue(function () {
    ...
    _proto.remember = function remember() {
      ...
      if (toggleState === CLASS_NAME_COLLAPSED) {
        if (this._options.noTransitionAfterReload) {
          $body.addClass('hold-transition').addClass(CLASS_NAME_COLLAPSED).delay(1500).queue(function () {
        ...
        $body.addClass('hold-transition').removeClass(CLASS_NAME_COLLAPSED).delay(1500).queue(function () {
          $__default["default"](this).removeClass('hold-transition');
          $__default["default"](this).dequeue();
        });
      } else {
