    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-sm-12">
              <center>
                  <img class="img-fluid"  src="<?= $URL?>/d2dVisitador/Modules/ModulesImage/pregunta.png" style="width:150px;height:150px;"  >
                  <br> <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">          
                <a  href="<?= $URL ?>/d2dVisitador/closeSession/controller/closeSession.php"
                    class="btn btn-primary btn-block" 
                    style="margin:4px;"  >Si</a>
            </div>
            <div class="col-sm-4">              
                <button type="button" 
                        class="btn btn-primary btn-block "  
                        data-dismiss="modal" 
                        style="margin:4px;" >No</button>
            </div>
            <div class="col-sm-2"></div>
        </div>     
      </div>
