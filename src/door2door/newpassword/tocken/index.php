...
/*<Import>*/   
    ...
    use  door2door\Modules\ModulePugins\Conection\Conection             as Conection;
    ...
    <body>  
        ...
        <script type="module">               
            ...
            $( document ).ready( () => { 
                $('#button-cambiar-contrasena-door2door').on('click', () => { 
                    ...
                    if(PASSWORD_UNO != '' && PASSWORD_DOS != '')
                    {
                        if(PASSWORD_UNO == PASSWORD_DOS){
                                ...
                                $.ajax({
                                    url: "/door2door/newpassword/tocken/api/door2door.controller.newmember.php",
                                    type: 'post',
                ...
                /*<REGRESAR>*/
                    $('#button-regresar-token').on('click', () => { window.location.href = "/door2door/login/"; });
                /*<REGRESAR>*/
            });
