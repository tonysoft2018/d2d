...
*/ 
/*<import>*/
    import grabarAPI      from '../API/API.Grabar.main.js';
...
/*<grabar>*/  
    const grabar = async() => {  console.log("Hola")
        let id = $('#grabar-id-door2door').val();
        if(id > 0){
            /*<grabar>*/
                let informationForm = new FormData(document.getElementById("form-grabar-door2door")); 
                const Result = await grabarAPI(informationForm).
                then((result)=> {  console.log(result);
                    if(result.message == 'Good'){
                        /*<Respuesta>*/
                            $('#message-succes-door2door').html("");
                            $('#message-succes-door2door').html('ELIMINACIÓN EXITOSA');
                            $('#modal-message-succes-door2door').modal('show'); 
                            $('#modal-grabar-door2door').modal('hide'); 
                        /*</Respuesta>*/     
