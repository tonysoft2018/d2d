            ...
            <form id="form-create-door2door" >    
              ...
              <div class="row">
                <div class="col-sm-6">                  
                  ...
                  <input type="text" disabled id="create-folio-door2door" style="background:#D1F0F5;"  name="create-folio-door2door" placeholder="folio" class="form-control" style="background:#D1F0F5;"   >
                </div>
                <div class="col-sm-6">                  
                  <div class="row">
                    <div class="col-sm-12  h6" >
              ...
              <div class="row"> 
                <div class="col-sm-12"> 
                  ...
                  <select class="custom-select" id="create-tipocampana-door2door" name="create-tipocampana-door2door" style="background:#D1F0F5;" >
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="create-descripcionrecoleccion-door2door" name="create-descripcionrecoleccion-door2door" placeholder="Descripción" rows="4"></textarea>
                  </div>
                </div>
              </div><br>  
              ...
              <div class="row">
                <div class="col-sm-5">   
                   <button type="button" class="btn btn-primary btn-block"   id="button-new-creat-door2door" >Crear</button>
                </div>
