    ...
    <!-- -->
        <head>
            ...
            <style>
                ...
                .map-responsive {
                    overflow:hidden;
                    padding-bottom:50%; /*Reduce este valor si el mapa fuera muy alto, por ejemplo 250px, puedes usar porcentajes, 50%*/
                    position:relative;
        ...
        <div id="id-main" class="opacidad"> 
            <div class="wrapper">
                ...
                <!-- Modales -->
                    ...
                    <?php include_once('ModalContactosMapa.php');         ?> 
                    <?php include_once('ModalRecalculo.php');             ?> 
