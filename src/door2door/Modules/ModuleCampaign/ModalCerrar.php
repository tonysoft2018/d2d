<!-- Modal -->
<div class="modal fade" id="modal-cerrar-door2door" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-cerrar-door2door">
          <input type="hidden" value="" id="cerrar-id-door2door" name="cerrar-id-door2door">
      </form>
        <div class="row">
