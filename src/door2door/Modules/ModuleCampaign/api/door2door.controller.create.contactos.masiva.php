                            ...
                            for($i = 1; $i < count($JSON_CONTACTOS); $i++){
                                ...
                                if($TOTAL_CONTACTO == 0){                                
                                    if( 
                                        ...
                                        $RESPUESTA_INSERTAR_UNO['ARREGLO_PAIS']             = $ARREGLO_PAIS_2;
                                        $RESPUESTA_INSERTAR_UNO['ARREGLO_ESTADO']           = $ARREGLO_ESTADO_2;
                                        $RESPUESTA_INSERTAR_UNO['ARREGLO_MUNICIPIO']        = $ARREGLO_MUNICIPIO_2;
