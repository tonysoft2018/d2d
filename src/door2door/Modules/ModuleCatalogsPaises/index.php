...
<!DOCTYPE html>
<?php if(   
            isset($_SESSION['rolUser-door2door']) &&  $_SESSION['rolUser-door2door'] == 'ADMINISTRADOR' 
        ){
?>
    <html lang="en">
        <!-- -->
            <head>
                <title> door2door | Países </title>
        ...
        <body class="hold-transition sidebar-mini layout-fixed">
            <div class="wrapper">    
                            ...
                            <div class="container-fluid">
                                <div class="container">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <i class="breadcrumb-item ">Países </li>
                                        </ol>
                                    </div><!-- /.col -->
                                    </div><!-- /.row -->
                                </div>
                ...
                <!-- Modales -->
                    ...
                    <?php include_once('ModalPlantilla.php');?> 
