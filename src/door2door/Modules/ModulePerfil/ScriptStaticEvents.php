        ...
        /*<Main Module Roles>*/               
                ...
                if( password != '' &&  passwordNew != '' ){
                    if(password == passwordNew){
                        if(password.length > 8){
                            ...
                            $.ajax({
                                url: "/door2door/Modules/ModulePerfil/api/door2door.controller.password.php",
                                type: 'post',
                                async: false,
                                dataType: "json",
                                data: { 
            ...
            $('#button-guardar-door2door').on('click', () =>{ 
                ...
                if( nombres != '' &&  apellidos != '' ){
                    let TockenOfdoor2doordoor2door = $('#tocken-door2doors-01198756765345431234534').val();               
                    $.ajax({
                        url: "/door2door/Modules/ModulePerfil/api/door2door.controller.create.php",
                        type: 'post',
                        async: false,
                        dataType: "json",
                        data: { 
            ...
            $('#button-imagen-guradar-door2door').on('click', () =>{ 
                ...
                $.ajax({
                    url: "/door2door/Modules/ModulePerfil/api/door2door.controller.imagen.php",
                    type: 'post',
                    async: false,
