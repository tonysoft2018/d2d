<?php
/*<Include classes>*/
    include_once('../model/door2door.model.Socios.php');
...
/*<Import>*/   
    ...
    use  door2door\Modules\ModulePerfilesSocio\Model\Socios\Socios                            as Services_create;
/*</Import>*/
                ...
                /*</Proceso>*/  
                    foreach($_FILES as $file){
                        if($file["error"]==UPLOAD_ERR_OK){
                            ...
                            $Direccion = '/door2door/Modules/ModulePerfilesSocio/api/Documentos/D2D_File_'.date("Ymdhis")."__".$file["name"];
                            $JSON_RESULT =  $Object->updateImagen(
