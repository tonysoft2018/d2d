<!-- Modal -->
<div class="modal fade" id="modal-activa-door2door" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-activa-door2door">     
          ...
          <input  type="hidden" id="activa-id-door2door"  name="activa-id-door2door">         
        </form>
        <div class="row">
            <div class="col-sm-3"></div>
            <div class="col-sm-3">              
              <button class="btn btn-primary" 
                      id="button-activa-door2door"  
