    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-delete-door2door">     
          ...
          <input  type="hidden" id="delete-id-door2door"  name="delete-id-door2door"> 
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Comentario</label>
                <textarea class="form-control" id="delete-comentario-door2door" name="delete-comentario-door2door" placeholder="Comentario" rows="4"></textarea>
              </div>
            </div>
          </div><br>
        </form>
