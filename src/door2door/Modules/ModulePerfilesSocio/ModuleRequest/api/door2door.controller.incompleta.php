...
/*<Import>*/   
    ...
    use  door2door\Modules\ModulePerfilesSocio\ModuleRequest\Model\Solicitudes\Solicitudes                      as Solicitudes_create;
/*</Import>*/
    ...
    if(isset($_POST['TockenOfdoor2doordoor2door']) && (
        ...
        /*<Controlador>*/
            try{
                ...
                /*</Instaciacion de objetos>*/      
                /*</Proceso>*/  
                    $JSON_RESULT = $ObjectRoles->incompleta(
                        $_POST['incompleto-id-door2door'],
                        $_POST['incompleto-comentario-door2door']
                    );
                /*</Proceso>*/  
                /*<Respuesta>*/  
