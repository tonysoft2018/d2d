...
/*<Import>*/   
    ...
    use  door2door\Modules\ModulePerfilesSocio\ModuleRequest\Model\Solicitudes\Solicitudes       as Usuarios_create;
/*</Import>*/
            ...
            try{     
                ...
                /*<Proceso>*/  
                    ...
                    $JSON_RESULT = $Object->update(
                                            ...
                                            $_POST['update-apellido-door2door'],
                                            $_POST['update-email-door2door'],
                                            $_POST['update-tipousuario-door2door']
                                    );    
                /*</Proceso>*/  
