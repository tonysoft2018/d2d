...
/*<Import>*/   
    ...
    use  door2door\Modules\ModulePerfilesSocio\ModuleRequest\Model\Solicitudes                      as Solicitudes_create;
/*</Import>*/
            ...
            try{
                ...
                /*</Proceso>*/  
                    $JSON_RESULT = $ObjectRoles->contrato(
                        $_POST['contrato-id-door2door'],
                        $_POST['contrato-comentario-door2door']
                    );
                /*</Proceso>*/  
                /*<Respuesta>*/  
