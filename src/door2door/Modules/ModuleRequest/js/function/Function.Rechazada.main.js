...
/*<import>*/
    import RechazarAPI      from '../API/API.Rechazar.main.js';
...
/*<Delete>*/  
    const Rechazar = async() => { 
        ...
        let idSolicitud     =    $('#rechazar-id-door2door').val();
        ...
        if( idSolicitud > 0 && comentario != ''){
            ...
            /*<RechazarAPI>*/      
                let informationForm = new FormData(document.getElementById("form-rechazar-door2door"));           
                const Result = await RechazarAPI( informationForm ).
                then((result)=> {  console.log(result)
                    if(result.message == 'Good'){
                        ...
                        /*<Respuesta>*/
                            ...
                            $('#modal-rechazar-door2door').modal('hide'); 
