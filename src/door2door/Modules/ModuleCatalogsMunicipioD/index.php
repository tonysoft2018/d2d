...
<?php if(isset($_SESSION['rolUser-door2door']) && $_SESSION['rolUser-door2door'] == 'ADMINISTRADOR' ){?>
    ...
    <html lang="en">
        <!-- -->
            <head>
                <title> door2door | Municipio / Delegaciones </title>
        ...
        <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="wrapper">
                        ...
                        <div class="content-header titulo-morado">
                            <div class="container-fluid">
                                <div class="container">
                                    <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <h1 class="m-0">Municipio / Delegaciones </h1>
                                    </div><!-- /.col -->
                                    <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                        <li class="breadcrumb-item"><a href="/door2door/Modules/Welcome/">Inicio</a></li>
                                        <i class="breadcrumb-item ">Municipio / Delegaciones </li>
                                        </ol>
                                    </div><!-- /.col -->
                                    </div><!-- /.row -->
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2"><!--
                                            <button type="button" 
                                                    ...
                                                    data-toggle="modal" 
                                                    data-target="#modal-cargar-door2door" >
                                                Cargar
                                            </button>-->
                                        </div>
                                        <div class="col-sm-2">
                                            <!--
                                                <button type="button" 
                                                        class="btn btn-info btn-block" 
                                                        data-toggle="modal" 
                                                        data-target="#modal-plantilla-door2door" >
                                                    Plantilla
                                                </button>
                                            -->
                                        </div>
                ...
                <!-- Modales -->
                    ...
                    <?= include_once('ModalPlantilla.php');?> 
                    <?= include_once('ModalCargar.php');?> 
                <!-- Modales -->
