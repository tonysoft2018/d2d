            ...
            <div class="col-sm-12">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="row"> 
                    <div class="col-sm-12"> 
                      <input type="hidden" id="update-idEstado-door2door">
                      <select class="custom-select" id="update-estado-door2door" name="update-estado-door2door" style="background:#D1F0F5;" >
