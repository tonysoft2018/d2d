...
/*<Include classes>*/
    include_once('../model/door2door.model.Services.php');
...
/*<Import>*/   
    ...
    use  door2door\Modules\ModuleCatalogsServices\Model\Services\Services       as Usuarios_create;
/*</Import>*/
                ...
                /*<Proceso>*/  
                    ...
                    foreach($_FILES as $file){
                        if($file["error"]==UPLOAD_ERR_OK){
                            move_uploaded_file($file["tmp_name"], "./Documentoss/CAGG_File_".date("Ymdhis")."__".$file["name"]);   
                            $Direccion = '/door2door/Modules/ModuleCatalogsServices/api/Documentos/CAGG_File_'.date("Ymdhis")."__".$file["name"];
