                ...
                for(let i = 0; i <Information.length; i++) {
                    ...
                    record =  `
                            <tr>
                                ...
                                <td style="width:200px;vertical-align:middle;" class="text-justify">
                                    <img class="img-fluid" style="width:80px;height:80px" src="${Information[i].imagen}">
                                </td>         
