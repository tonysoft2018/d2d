...
/*<import>*/    
    import crearAPI        from '../API/API.crear.main.js';
...
/*<crear>*/           
    const crear = async() => { 
        /*<Captura>*/
            let nombre          =   $('#crear-nombre-door2door').val().replace(/['"`]/, '');
            let descripcion     =   $('#crear-descripcion-door2door').val().replace(/['"`]/, '');
            let imagen          =   $('#crear-imagen-door2door').val().replace(/['"`]/, '');
            /*<Eliminamos caracteres extraños>*/
                $('#crear-nombre-door2door').val(nombre);
                $('#crear-descripcion-door2door').val(descripcion);               
            /*<Eliminamos caracteres extraños>*/
        /*</Captura>*/
        ...
        if( ResultSelectFull.message == 'Good' ){     
            ...
            if(nombre != '' && imagen != '' ){
                ...
                /*<Validar>*/
                    if( Accoun == 0 ){     
                        let informationForm = new FormData(document.getElementById("form-crear-door2door")); 
                        const ResultcrearAPI= crearAPI( informationForm ).
                        then((result) => {    console.log(result)          
                            if(result.message == 'Good'){ 
                                /*<Respuesta>*/
                                    ...
                                    $('#crear-nombre-door2door').val('');
                                    $('#crear-descripcion-door2door').val('');
                                    $('#crear-imagen-door2door').val('');

                                    $('#modal-crear-door2door').modal('hide'); 
                                /*</Respuesta>*/   
                ...
                /*<Respuesta>*/
                    $('#crear-nombre-door2door').addClass("is-invalid");   
                /*</Respuesta>*/             
            }                        
        }else{
