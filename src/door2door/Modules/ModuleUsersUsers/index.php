...
<?php if(isset($_SESSION['rolUser-door2door']) && $_SESSION['rolUser-door2door'] == 'ADMINISTRADOR' ){?>
    ...
    <html lang="en">
        <!-- -->
            <head>
                <title> door2door | Usuarios </title>
            ...
            <div class="wrapper">
                ...
                <div id="id-main" class="opacidad" > 
                    <div class="content-wrapper">
                        ...
                        <div class="content-header titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado">
                            <div class="container-fluid">
                                <div class="container">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <i class="breadcrumb-item ">Usuarios</li>
                                        </ol>
                                    </div><!-- /.col -->
                                    </div><!-- /.row -->
                                </div>
