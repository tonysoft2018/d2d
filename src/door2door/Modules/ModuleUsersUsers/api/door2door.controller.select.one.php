...
/*<Import>*/   
    use  door2door\Modules\ModulePugins\GeneradorTocken\GeneradorTocken   as GeneradorTocken_selecrOne;
    use  door2door\Modules\ModuleUsersUsers\model\Usuarios\Usuarios       as Usuarios_create;
/*</Import>*/

/*<Instaciacion de objetos>*/                
    $ObjectToken = new GeneradorTocken_selecrOne();
/*</Instaciacion de objetos>*/
    ...
    if(isset($_POST['TockenOfdoor2doordoor2door']) && (
        ...
        /*<Controlador>*/      
            try{
                ...
                /*</Proceso>*/  
                    $JSON_RESULT = [];   
                    $JSON_RESULT = $ObjectRoles::selectOne($_POST['select-id-door2door']); 
                /*</Proceso>*/  
