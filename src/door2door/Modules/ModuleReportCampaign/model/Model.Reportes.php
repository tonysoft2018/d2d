...
class Reportes extends ConectionCommission{
    ...
    public function CreacionPDF($FechaInicio, $FechaFinal){
        /*<Consulta empresas>*/
    ...
    public function CreacionExcel($FechaInicio,$FechaFinal){
        ...
        $this->open();
            ...
            if ($result = mysqli_query($this->Connection, $Query)) { 
                    ...
                    $URL        = 'Location: '.$SERVER.'/door2door/Modules/ModuleReportCampaign/api/'.$nombre.'.xlsx';
