...
<?php if(isset($_SESSION['rolUser-door2door']) && $_SESSION['rolUser-door2door'] == 'ADMINISTRADOR' ){?>
    ...
    <html lang="en">
        <!-- -->
            <head>
                <title> door2door | Conceptos de comición </title>
            ...
            <div class="wrapper">
                ...
                <div id="id-main" class="opacidad" > 
                    <div class="content-wrapper">
                        ...
                        <div class="content-header titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado titulo-morado">
                            <div class="container-fluid">
                                <div class="container">
                                    <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <h1 class="m-0">Conceptos de pago</h1>
                                    </div><!-- /.col -->
                                    <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                        <li class="breadcrumb-item"><a href="/door2door/Modules/Welcome/">Inicio</a></li>
                                        <i class="breadcrumb-item ">Conceptos de pago</li>
                                        </ol>
                                    </div><!-- /.col -->
                                    </div><!-- /.row -->
                                </div>
