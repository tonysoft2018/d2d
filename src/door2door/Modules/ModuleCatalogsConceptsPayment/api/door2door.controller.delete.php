...
/*<Include classes>*/
    include_once('../model/door2door.model.ConceptsPayment.php');
...
/*<Import>*/   
    ...
    use  door2door\Modules\ModuleCatalogsConceptsPayment\Model\ConceptsPayment\ConceptsPayment           as Usuarios_create;
/*</Import>*/
    ...
    if(isset($_POST['TockenOfdoor2doordoor2door']) && (
        ...
        /*<Controlador>*/
            try{
                ...
                /*</Instaciacion de objetos>*/      
                /*</Proceso>*/  
                    $JSON_RESULT = $ObjectRoles->delete($_POST['delete-id-door2door']);
                /*</Proceso>*/  
                /*<Respuesta>*/  
