                ...
                for(let i = 0; i <Information.length; i++) {
                    ...
                    record =  `
                            <tr>
                                ...
                                <td style="width:200px;vertical-align:middle;" class="text-justify">${Information[i].tipoCuestionario}</td>        
                                <td style="width:220px;vertical-align:middle;">
                                    <center>
                                        <img        class="cursor"  
                                                    title="Mostrar" 
                                                    onclick="ButtonShow(
                                                                 ${Information[i].idCuestionario},
                                                                '${Information[i].nombre}',
                                                                '${Information[i].tipoCuestionario}',
