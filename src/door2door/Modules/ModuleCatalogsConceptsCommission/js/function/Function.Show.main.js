                ...
                for(let i = 0; i <Information.length; i++) {
                    ...
                    record =  `
                            <tr>
                                ...
                                <td style="width:200px;vertical-align:middle;" class="text-justify">${Information[i].tipo}</td>    
                                <td style="text-align:right;width:200px;vertical-align:middle;" class="text-justify">${Information[i].comision}</td>  
                                <td style="text-align:right;width:200px;vertical-align:middle;" class="text-justify">${Information[i].cantidad}</td>    
                                ...
                                <td style="width:220px;vertical-align:middle;">
                                    <center>
                                        <img        class="cursor"  
                                                    title="Mostrar" 
                                                    onclick="ButtonShow(
                                                                 ${Information[i].idCComicion},
                                                                '${Information[i].nombre}',
                                                                '${Information[i].descripcion}',
                                                                '${Information[i].tipo}',
                                                                '${Information[i].comision}',
                                                                '${Information[i].cantidad}',
                                                                '${Information[i].idZona}'
                                                            );" 
