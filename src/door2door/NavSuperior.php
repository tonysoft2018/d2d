    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown" >
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;" >
                ...
                <a href="/door2door/Modules/ModuleMessageChat/" class="dropdown-item dropdown-footer">Ver todos los mensajes</a>
            </div>
        </li>
        <li class="nav-item dropdown" >
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"style="color: black;" >
                ...
                <a href="#" class="dropdown-item mostra-notificaciones" style="color: black;" id="totalNotificacionessubmenuTercero">
