...
/*<Import>*/   
    ...
    use  d2dSocioWeb\Modules\ModulePerfil\Model\usuario \usuario             as usuario;
/*<Import>*/   
        ...
        /*<Controlador>*/      
            try{
                ...
                foreach($_FILES as $file){
                    ...
                    {
                        move_uploaded_file($file["tmp_name"], 'Documentos/'.date("Ymdhis").".".$file["name"]);    
                        $DIRECCION = '/d2dSocioWeb/Modules/ModulePerfil/api/Documentos/'.date("Ymdhis").".".$file["name"];                         
                    }
                }
                $JSON_RESULT =  $Object->UpdateImagen($DIRECCION);   
                /*<Respuesta>*/  
