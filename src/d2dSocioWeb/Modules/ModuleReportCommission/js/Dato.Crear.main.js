...
const Crear = async() => { 
    ...
    if( 
        ...
        let win = window.open( `/d2dSocioWeb/Modules/ModuleReportCommission/api/door2door.controller.create.php?file=${file}&FechaInicio=${FechaInicio}&FechaFinal=${FechaFinal}&token=423421342442134242134214412421342341234234`, '_blank');
