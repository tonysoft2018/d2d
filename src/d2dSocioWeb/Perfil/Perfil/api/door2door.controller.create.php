...
/*<Import>*/   
    ...
    use  d2dSocioWeb\Modules\ModuleSettingsCompanies\Model\SettingsCompanies\SettingsCompanies              as Services_create;
/*<Import>*/   
            ...
            try{
                ...
                foreach($_FILES as $file){
                    if($file["error"]==UPLOAD_ERR_OK){
                        ...
                        $Direccion = '/d2dSocioWeb/Modules/ModuleSettingsCompanies/api/Documentos/door2door_File_'.date("Ymdhis")."__".$file["name"];
