...
/*<Import>*/   
    use  d2dSocioWeb\Modules\ModulePugins\GeneradorTocken\GeneradorTocken as GeneradorTocken;
    //use  d2dVisitador\Messages\Model\Notificaciones\Notificaciones         as Notificaciones;
/*<Import>*/ 
...
/*<Validacion de tocken>*/
    if(isset($_POST['TockenOfdoor2doordoor2door']) && (
        ...
        /*<Controlador>*/   
            try{
                /*<Instaciacion de objetos>*/                
                    $Object = new Notificaciones();
                /*</Instaciacion de objetos>*/      
                /*</Proceso>*/  
                    $JSON_RESULT = $Object->VistoNotificaciones($_POST['idNotificacion']);
                /*</Proceso>*/  
                /*<Respuesta>*/  
