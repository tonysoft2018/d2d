    ...
    <body>  
                ...
                <div class="card login-form">
                    <div class="card-body">
                        ...
                        <div class="card-text">                           
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="/d2dSocioWeb/login/"  id="button-inicialr-sesion-door2door" class="btn btn-success btn-block">Inicio de sesion</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="module">               
            ...
            $( document ).ready( () => {                 
                ...
                $('#message-regresar-door2door').on('click', () => {  window.location.href = "/d2dSocioWeb/login/" });  
